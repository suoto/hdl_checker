...
#  patchBuilder = mock.patch('hdlcc.builders.getBuilderByName', new=lambda name: MockBuilder)


#  @contextmanager
#  def mockBuilder():
#      with mock.patch('hdlcc.builders.getBuilderByName', new=lambda name: MockBuilder):
#          with mock.patch('hdlcc.config_parser.AVAILABLE_BUILDERS', [MockBuilder, ]):
#              _logger.fatal("Entered mock")
#              yield
#              _logger.fatal("Exited mock")

#   #  patchBuilder = mock.patch('hdlcc.builders.getBuilderByName', new=lambda name: MockBuilder)(
#   #                 mock.patch('hdlcc.config_parser.AVAILABLE_BUILDERS', [MockBuilder, ]))

#  #  mockBuilder = mock.patch('hdlcc.builders.getBuilderByName', new=lambda name: MockBuilder)(
#  #          mock.patch('hdlcc.config_parser.AVAILABLE_BUILDERS', [MockBuilder, ]))
...
with such.A("hdlcc project") as it:
    ...
    it.assertSameFile = assertSameFile
...
#          it.assertTrue(project.builder.builder_name, 'MockBuilder')
...
#          open(p.join(TEMP_PATH, '.hdlcc', CACHE_NAME), 'a').write("something\n")
